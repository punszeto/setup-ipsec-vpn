...
1. Click **Allow these protocols**. Make sure ONLY "Challenge Handshake Authentication Protocol (CHAP)" is checked and all others unchecked.
...
1. Click the **Security** tab and select "Layer 2 Tunneling Protocol with IPsec (L2TP/IPSec)" from the **Type of VPN** drop-down menu.
1. Under **Allow these protocols**, make sure ONLY "Challenge Handshake Authentication Protocol (CHAP)" is checked and all others unchecked.
1. Click the **Advanced settings** button.
1. Select **Use preshared key for authentication** and enter `Your VPN IPsec PSK` for the **Key**.
1. Click **OK** to close the **Advanced settings**.
1. Click **OK** to save the VPN connection details.
